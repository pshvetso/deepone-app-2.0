...
INSERT INTO `tbl_user` (`user_id`, `avatar_id`, `first_name`, `hash`, `last_name`, `last_visit_date`, `username`,
                        `reg_date`)
VALUES (1, 0, 'Britney', 1, 'Spears', '2019-11-20 00:00:00', 'britneyspears', '2019-11-20 00:00:00'),
       (2, 0, 'Elizabeth', 2, 'Hurley', '2019-11-19 00:00:00', 'elizabethhurley', '2019-11-20 00:00:00'),
       (3, 0, 'Salma', 3, 'Hayek', '2019-11-18 00:00:00', 'salmahayek', '2019-11-20 00:00:00');

--
-- Дамп данных таблицы `post`
--

INSERT INTO `post` (`post_id`, `date`, `title`, `user_id`)
VALUES (1, '2019-12-01 00:00:00', 'Britney Spears latest outfit', 1),
       ...
       (7, '2019-12-07 00:00:00',
        'Самые лучшие фейковые снимки получались со спортивных сайтов или с фотографий, сделанных в купальниках. ', 3),
...
INSERT INTO `view` (`view_id`, `post_id`, `user_id`)
VALUES (1, 1, 2),
       (2, 2, 3),
       (3, 3, 1);
...
INSERT INTO `tbl_like` (`like_id`, `post_id`, `user_id`)
VALUES (1, 1, 2),
       (2, 2, 3),
       (3, 3, 1);
